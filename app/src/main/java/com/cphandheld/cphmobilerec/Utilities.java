...
//        TimeZone tz =  sf.getTimeZone();
    ...
    public static Boolean canAccessCoarseLocation(Activity activity) {
        return (Utilities.hasPermission(activity, Manifest.permission.ACCESS_COARSE_LOCATION));
    }

    public static Boolean canReadPhoneState(Activity activity) {
        return (Utilities.hasPermission(activity, Manifest.permission.READ_PHONE_STATE));
    }
}
